<?php
 ...
 $reportid = base64_decode($_GET['report_id']);
	$report = $functions->getSeoSubmittedReportById($reportid);
	$Links = $functions->getSeoSubmittedLinksByReportId($reportid);
	//print_r($Links);exit;
    ...
    // print_r($links);
      foreach($links as $row){
        if($row['id']){
           ...
           $linkId = $functions->UpdateSubmittedLinksByLinkId($linkid,$data);
        }else{
         	$data = array_merge(['report_id'=>$reportid],$row,['created'=>$date]);
          $linkId = $functions->insertSubmittedLinks($data);
        }
      }
	   $reportdata = array('created'=>$date);
       $reportupdate=$functions->UpdateSubmittedReportByReportId($reportid,$reportdata);
    //echo $linkId;
     if($linkId){
     	$Links = $functions->getSeoSubmittedLinksByReportId($reportid);
     }
   ...
   <div class="section__content section__content--p30">
       <div class="container-fluid">
           <div class="row">
               ...
               <form action="edit_submitted_links.php?report_id=<?php echo base64_encode($reportid);?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="append_div">
                     ...
                     <div class="row form-group">
					   ...
					   <div class="col col-md-3">
                        ...
                        <input type="text" name="link[<?php echo $i;?>][website]" value="<?php echo $link['website']; ?>" class="form-control">
                        </div>
                       ...
                       <div class="col col-md-3">
                        ...
                        <div class="col col-md-1">
                         <label for="text-input" style="margin: 0!important;">Follow Link</label>
