...
$deal_one_count=$accountsfunctions->getCountofDealsByDealId("1");
$deal_two_count=$accountsfunctions->getCountofDealsByDealId("2");
$deal_three_count=$accountsfunctions->getCountofDealsByDealId("3");
$deal_four_count=$accountsfunctions->getCountofDealsByDealId("4");
$deal_lost_count=$accountsfunctions->getCountofDealsByDealId("0");
/*--------------------------all data-------------------------*/
$deal_one=$accountsfunctions->getDealsByDealId("1");
$deal_two=$accountsfunctions->getDealsByDealId("2");
$deal_three=$accountsfunctions->getDealsByDealId("3");
$deal_four=$accountsfunctions->getDealsByDealId("4");
$deal_lost=$accountsfunctions->getDealsByDealId("0");
/*echo "<pre>";
print_r($deal_one);
exit;*/
?>
...
<div class="main-content" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="col-md-3">
        ...
        <div class="col-md-3">
         ...
         <div class="col-md-3">
                    <label style="margin-bottom: 0">Assigned :</label>
                    <div class="input-group">
                           <select class="form-control" id="updated_by" name="updated_by">
                             <option value="" selected disabled>Select here</option>
                            <?php foreach($getmanagers as $value){ ?>
                            <option value="<?php echo $value['employee_id'];?>"><?php echo $value['firstname']." ".$value['lastname']; ?></option>
                              <?php } ?>
                           </select>
                      </div>
                </div>
         <div class="col-md-2">
           <label></label>
          <button class="btn btn-primary" style="margin-top: 20px;" id="deal_filter">Filter</button>
           </div>
<!------    <div class="col-md-2">
            <label style="margin-bottom: 0">From Amount($):</label>
            <div class="input-group">
                <input  type="text" class="form-control" name="from_amount" id="from_amount"">
            </div>
        </div>
        <div class="col-md-2">
            <label style="margin-bottom: 0">To Amount($):</label>
            <div class="input-group">
                <input  type="text" class="form-control" name="to_amount" id="to_amount"">
            </div>
        </div>----->
    </div>
    </div>
                        ...
                        <div class="row" style="height: 400px;">
                            ...
                            <div class="col-sm-6 deal_text">
                                ...
                                foreach ($deal_lost as $row){
                                    ...
                                    $sum += $row['exp_deal_amount'];?>
                                    <div class="deal_content">
                                        <i class="fa fa-user-circle" style="font-size: 16px;color: gray"></i><strong>
                                            <a href="contact_details.php?lead_id=<?php echo base64_encode($lead['id']);?>"
                                               target="_blank"><?php echo $lead['fname']." ".$lead['lname'];?></a>
                                        </strong>
        ...
        $("#deal_filter").click(function () {
           ...
           // var from_amount=$("#from_amount").val();
            ...
            $.ajax({
                ...
                data: ({deal_filter:deal_filter,from_date: from_date,to_date:to_date,updated_by:updated_by}),
