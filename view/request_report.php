	...
	if(isset($_POST['Submit']) && $_POST['Submit']=="request_report" && $_POST['request_report']!= " " ){
     ...
     if($reqId != 0){
      ...
      $post = array(
         ...
         //http://182.73.4.147/rtts/API/requesteddata
         //http://172.16.20.4
         $ch1 = curl_init();
         curl_setopt($ch1, CURLOPT_URL, 'http://34.93.179.172/rtts/API/requesteddata');
                                ...
                                <div class="row form-group">
                                   <div class="col col-md-6">
                                       <label for="text-input" class=" form-control-label">Title Name *</label>
                                        <input type="text" id="title_name" name="title_name" placeholder="Enter Title Name" class="form-control" required value="<?= $company['report_name']?>">
                                    </div>
                                   <div class="col col-md-6">
                                     ...
                                     <div class="col col-md-6">
                                         <label for="text-input" class=" form-control-label">Request Type *</label>
                                          ...
                                          <!-- <option value="" selected disabled>Select stage</option>-->
                                           ...
                                           <option id="theSelect" value="Custom Request">Custom Request</option>
                                          </select>
                                      </div>
                                     <div class="col col-md-6">
