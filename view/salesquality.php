...
$getSalesTeam=$functions->getSalesManager();
?>
            ...
            <div class="row filters-card">
                <div class="col-lg-12">
                    <div class="row">						
                       ...
                       <div class="col-sm-3">
                           <select class="select-modal-rows" name="associate_id" id="associate_id" style="width: 100%">
								<?php foreach($getSalesTeam as $value){ ?>
...
<script>
    $(document).ready(function() {
        $('#reportSearch').click(function() {
            var associatedid = $("#associate_id").val();
            var fromdate = $("#fromdate").val();
            var todate = $("#todate").val();
            $.ajax({
                type: "GET",
                url: 'salesqualityview.php',
                data: ({fromdate:fromdate,todate: todate,assignedto:associatedid}),
