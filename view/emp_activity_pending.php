...
$Leads= $functions->getEmpleadsActivityPending($associate_id,$finalleads);
//print_r($Leads);
//exit;
?>
<style>
...
$(document).ready(function() {
    ...
    $("#leadSearch").click(function(){
        ...
        var todate = $("#todate").val();
          $.ajax({
            type: "POST",
            url: 'ajax/ajax_emp_activity_pending.php',
            data: ({ leadids:leadids, fromdate:fromdate,todate: todate}),
