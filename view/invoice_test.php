         ...
         <div class="row col-sm-5 bal-amount">
             ...
             <div class="col-sm-6">
               ...
               <div class="payment-title">Payment Details</div>
						...
						<a href="https://crm.industryarc.in/api/paypal/index.php?amtval=<?php echo base64_encode($total); ?>&txnid=<?php echo base64_encode($invoiceid); ?>" target="_blank"><img style="width:50px;" src="images/paypal.png"></a>
						<a href="https://crm.industryarc.in/api/ccavenue/ccavReq.php?amtval=<?php echo base64_encode($total); ?>&txnid=<?php echo base64_encode($invoiceid); ?>" target="_blank" ><img style="width:50px;" src="images/ccavenue.png"></a>
                </div>
               </div>
