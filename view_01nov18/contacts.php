            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12" style="margin-bottom: 20px;">
                    ...
                    <div class="row col-sm-6">
                        ...
                        <div class="col-sm-1">
                            <button class="btn btn-danger" id="removefilter" style="font-size: 12px;padding:5px;">Remove filter</button>
                        </div>
                    </div>
            </div>
           <div class="col-lg-12">
                           ...
                           <div class="row"style="font-size: 14px;width: 100%;">
                               ...
                               <div class="row close-input" id="7">
                                   ...
                                   <select class="filter-control" id="status" name="filter-control">
                                       ...
                                       <option class="option-display" value="1">Approve</option>
                                       <option class="option-display" value="2">Reject</option>
                                   </select>
                                   <button type="button" class="filter-close">&times;</button>
                               </div>
