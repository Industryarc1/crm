...
$("#search-leads").click(function () {
        ...
        //var domain=$("#department").val();
        var country=$("#country").val();
        var reportcode=$("#report-code").val();
        $.ajax({
            type: "GET",
            url: 'ajax_lead.php',
            data: ({filterleads:filterleads,fname: fname,lname:lname,email:email,phone:phone,
                jobtitle:jobtitle,company:company,reportcode:reportcode,country:country}),
                success: function(result){
