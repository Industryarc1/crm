<?php
	...
	if(isset($_POST['Submit']) && $_POST['Submit']=="add emp"){
		...
		if($adminCheck['employee_id']==""){		
			...
			$to=$_POST['email'];
			$subject="Successfully Registered on CRM";
			$message='<div class="col-sm-3">
			<h5>Dear '.$_POST['username'].',</h5>
			</div>
			<div class="col-sm-8">
			<p><br>You are succesfully registered in Crm Portal.Your new password of 
			your registered mail is <strong>'.$_POST['password'].'</strong>.</p>
			</div>
			<div class="col-sm-3">
			<p><br>Regards,<br>
